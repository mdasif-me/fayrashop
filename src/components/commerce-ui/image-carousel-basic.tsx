...
const ImageContainer: React.FC<{
  ...
  return (
    <div
      className={cn('relative w-full overflow-hidden rounded-lg', getAspectRatioClass(aspectRatio))}
    >
      <Dialog>
        ...
        <DialogPortal>
          ...
          <DialogContent className="fixed inset-0 z-50 flex flex-col items-center justify-center">
            ...
            <div className="relative flex h-screen w-screen items-center justify-center">
              ...
              <DialogClose asChild>
                <button
                  className="absolute top-4 right-4 z-10 cursor-pointer rounded-full transition-colors"
                  aria-label="Close"
                >
                  <X className="size-6" />
                </button>
        ...
        {showCarouselControls && (
          <>
            <Button
              variant="outline"
              size="icon"
              className="absolute top-1/2 left-[2%] z-10 h-8 w-8 -translate-y-1/2 rounded-full backdrop-blur-xs disabled:opacity-50"
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute top-1/2 right-[2%] z-10 h-8 w-8 -translate-y-1/2 rounded-full backdrop-blur-xs disabled:opacity-50"
